...
<body>
		<div class="nav-bar">
			...
			<div class="nav-body-initial" id="navbar">
				<ul>
					<li>
						<a href="#" data-toggle="tooltip" data-placement="right" title="Add New Note">
							<button class="nav-icon">+</button>
						</a>
					</li>
					<li>
						<a href="#" data-toggle="tooltip" data-placement="right" title="Your Personal Diary">
		...
		<div class="row">
			<div class="col-sm-9 main-body">
				<h1>Hello, <font style="color: rgb(0,104,139)">Ashish </font></h1>
				<div class="row">
					<div class="col-sm-4 notes-container">
					...
					<div class="col-sm-8 editor">
						...
						<form action="save-note.php" method="POST">
							...
							<textarea name="body" placeholder="Start Typing Your Note Here..." class="body"></textarea>
